package com.netease.course.neteasecourse.中间件专题.消息中间件.RabbitMQ.消息可靠性;
    ...
    private static Runnable receive = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                channel = connection.createChannel();  //Dead Letter Queue(dlq)
                // 1、 创建一个exchange
                        ...
                        new DefaultConsumer(finalChannel) {
                            ...
                            public void handleDelivery(String consumerTag,
                                ...
                                try {
                                     ...
                                     * @param multiple
                                     * @param requeue true重发，false不重发(丢弃或者移到DLQ死信队列)，保证消息消费可靠性
                                     */
                                    finalChannel.basicNack(envelope.getDeliveryTag(), false, true);
                                }
                            }
                        });
