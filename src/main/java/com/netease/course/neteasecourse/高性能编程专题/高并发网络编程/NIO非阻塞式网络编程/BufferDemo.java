package com.netease.course.neteasecourse.高性能编程专题.高并发网络编程.NIO非阻塞式网络编程;
...
public class BufferDemo {
    ...
    public static void main(String[] args) {
        // 构建一个byte字节缓冲区，容量是4
        //ByteBuffer byteBuffer = ByteBuffer.allocateDirect(4);   //分配堆外内存
        ByteBuffer byteBuffer = ByteBuffer.allocate(4);           //分配堆内内存
        // 默认写入模式，查看三个重要的指标
        ...
        byteBuffer.flip();
        byte a = byteBuffer.get();  //读要一次，position位置往后挪一位
